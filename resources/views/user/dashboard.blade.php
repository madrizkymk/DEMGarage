...
@section('content')
  <main class="flex-grow mx-auto max-w-7xl px-4 py-6 sm:px-6 lg:px-8">
    <div class="mb-6">
      ...
      <p class="mt-2 text-gray-600">Welcome back! Manage your vehicle services.</p>
    </div>
    ...
    <section class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6">
        ...
        <div class="flex items-center">
          <div class="flex-shrink-0">
            <div
              ...
              <img src="{{ asset('asset/booking.png') }}" alt="Booking Icon" class="w-6 h-6" />
            </div>
          </div>
          <div class="ml-4">
            <h3 class="text-lg font-semibold text-gray-900 group-hover:text-blue-600 transition-colors">Booking</h3>
            <p class="text-sm text-gray-500">Schedule a new service</p>
          </div>
        </div>
      </a>

      <a href="{{ route('user.booked.index') }}"
        ...
        <div class="flex items-center">
          <div class="flex-shrink-0">
            <div
              ...
              <img src="{{ asset('asset/booked.png') }}" alt="Booked Services Icon" class="w-6 h-6" />
            </div>
          </div>
          <div class="ml-4">
            <h3 class="text-lg font-semibold text-gray-900 group-hover:text-green-600 transition-colors">Active Bookings
            </h3>
            <p class="text-sm text-gray-500">View your current bookings</p>
          </div>
        </div>
      </a>
      ...
      <a href="{{ route('user.history.index') }}"
        ...
        <div class="flex items-center">
          ...
          <div class="ml-4">
            <h3 class="text-lg font-semibold text-gray-900 group-hover:text-purple-600 transition-colors">Service History
            </h3>
            <p class="text-sm text-gray-500">View completed services</p>
          </div>
        </div>
      </a>
    </section>
    ...
    <section class="mt-8 bg-white rounded-xl shadow-sm border border-gray-200 p-6">
      ...
      <div class="grid grid-cols-1 sm:grid-cols-3 gap-4">
        <div class="text-center">
          <div class="text-2xl font-bold text-blue-600">{{ $bookings ?? 0 }}</div>
          <div class="text-sm text-gray-500">Total Bookings</div>
        </div>
        <div class="text-center">
          <div class="text-2xl font-bold text-green-600">{{ $activeBookings ?? 0 }}</div>
          <div class="text-sm text-gray-500">Active Services</div>
        </div>
        <div class="text-center">
          <div class="text-2xl font-bold text-purple-600">{{ $completedServices ?? 0 }}</div>
